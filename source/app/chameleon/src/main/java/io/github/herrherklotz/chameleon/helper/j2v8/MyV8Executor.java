 ...
 ******************************************************************************/
package io.github.herrherklotz.chameleon.helper.j2v8;
 ...
 */
public class MyV8Executor extends Thread {
	 ...
	 */
	public MyV8Executor(final String id, final String script, final boolean longRunning, final String messageHandler) {
		this.id = id;
		this.script = script;
	 ...
	 * @param script The script to execute on this executor.
	 */
	public MyV8Executor(final String id, final String script) {
		this(id, script, false, null);
	}
